        ...
        return http
                ...
                .authorizeHttpRequests(authRequest ->
                        authRequest
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/v1/appointments/availability", "/api/v1/appointments/availability/day", "/api/v1/appointments/availability/barbers").permitAll()
